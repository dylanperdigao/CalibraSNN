...
class Net_FFSNN_2h(nn.Module, BaseNet_FFSNN):
    def __init__(self, topology, params, input=None):
        ...
        self.lif3 = snn.Leaky(beta=self.betas[2], threshold=self.thresholds[2], spike_grad=self.spike_grad, learn_beta=True, learn_threshold=True, output=True)
        # Architecture
        self.architecture = f"""
        =====================
